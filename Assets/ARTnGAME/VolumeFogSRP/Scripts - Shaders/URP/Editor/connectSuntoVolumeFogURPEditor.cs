...
public class connectSuntoVolumeFogURPEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (enableEditor)
        {
            ...
            volumeFog.GlobalFogPower = EditorGUILayout.Slider(volumeFog.GlobalFogPower, 0.0f, 5);
            ...
            volumeFog.ClearSkyFac = EditorGUILayout.Slider(volumeFog.ClearSkyFac, -100, 100);
            ...
            if (enableLargeScaleHeightDensity)
            {
                ...
                volumeFog.heightDensity = EditorGUILayout.Slider(volumeFog.heightDensity, -100000, 2000000000);
            }
            else
            {
            ...
            volumeFog.contrast = EditorGUILayout.Slider(volumeFog.contrast, -60, 60);
            ...
            volumeFog.occlusionExp = EditorGUILayout.Slider(volumeFog.occlusionExp, -5, 10);
            ...
            volumeFog.stepsControl.w = EditorGUILayout.Slider(volumeFog.stepsControl.w, 0.0f, 150);
            EditorGUILayout.LabelField("Volumetric Fog Noise Scaling A");
            volumeFog.lightNoiseControl.z = EditorGUILayout.Slider(volumeFog.lightNoiseControl.z, 0.0f, 150);
            EditorGUILayout.LabelField("Volumetric Fog Noise Speed A");
            volumeFog.lightNoiseControl.w = EditorGUILayout.Slider(volumeFog.lightNoiseControl.w, -3500, 3500);
            ...
            volumeFog.lightControlA.x = EditorGUILayout.Slider(volumeFog.lightControlA.x, 0.0001f, 50);
            ...
            volumeFog.lightControlA.y = EditorGUILayout.Slider(volumeFog.lightControlA.y, 0.0001f, 50000);
            ...
            volumeFog.volumeSamplingControl.x = EditorGUILayout.Slider(volumeFog.volumeSamplingControl.x, -7, 7);
            ...
            else
            {
                ...
                volumeFog.volumeSamplingControl.z = EditorGUILayout.Slider(volumeFog.volumeSamplingControl.z, -30, 35);
